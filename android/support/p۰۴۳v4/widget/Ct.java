...
public class Ct {
    ...
    /* renamed from: b  reason: contains not printable characters */
    static void m۱۳۳۷۸b(ViewGroup parent, View descendant, Rect rect) {
    ...
    /* renamed from: a  reason: contains not printable characters */
    public static void m۱۳۳۷۶a(ViewGroup parent, View descendant, Rect out) {
        out.set(0, 0, descendant.getWidth(), descendant.getHeight());
        m۱۳۳۷۸b(parent, descendant, out);
    }

    /* renamed from: a  reason: contains not printable characters */
    private static void m۱۳۳۷۷a(ViewParent target, View view, Matrix m) {
