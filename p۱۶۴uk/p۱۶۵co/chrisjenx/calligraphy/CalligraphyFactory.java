...
public class CalligraphyFactory {
    ...
    public View onViewCreated(View view, Context context, AttributeSet attrs) {
        if (!(view == null || view.getTag(CR.Cid.calligraphy_tag_id) == Boolean.TRUE)) {
            onViewCreatedInternal(view, context, attrs);
            view.setTag(CR.Cid.calligraphy_tag_id, Boolean.TRUE);
        }
        return view;
    }
    ...
    public void onViewCreatedInternal(View view, Context context, AttributeSet attrs) {
        if (view instanceof TextView) {
            if (!TypefaceUtils.isLoaded(((TextView) view).getTypeface())) {
                ...
                CalligraphyUtils.applyFontToTextView(context, (TextView) view, CalligraphyConfig.get(), textViewFont, matchesResourceIdName(view, ACTION_BAR_TITLE) || matchesResourceIdName(view, ACTION_BAR_SUBTITLE));
            } else {
                return;
            }
        }
