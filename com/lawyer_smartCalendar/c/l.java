...
import com.lawyer_smartCalendar.a.m;
...
public class l extends f implements View.OnClickListener {
    ...
    public void a(View view, Bundle savedInstanceState) {
        ...
        this.b0 = (RecyclerView) view.findViewById(R.id.recyclerView_view);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.actionButton_add_note) {
            Intent frm_note = new Intent(d(), AddNoteActivity.class);
    ...
    public void d0() {
        i db = new i(d());
        db.n();
        List<Note> noteList = db.r(((ClientDetailActivity) d()).s);
        db.close();
        this.b0.setAdapter(new m(d(), this, noteList));
        if (noteList.isEmpty()) {
