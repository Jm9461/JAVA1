...
public class h extends f implements View.OnClickListener {
    ...
    public void a(View view, Bundle savedInstanceState) {
        ...
        this.b0 = (RecyclerView) view.findViewById(R.id.recyclerView_case_note_list);
    ...
    public void d0() {
        i db = new i(d());
        db.n();
        List<Note> noteList = db.q(((CaseDetailActivity) d()).r);
        db.close();
        this.b0.setAdapter(new com.lawyer_smartCalendar.a.h(d(), this, noteList));
        if (noteList.isEmpty()) {
