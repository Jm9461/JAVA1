...
public class Cb {
    ...
    static float[] m۱۰۴۲۵a(float[] original, int start, int end) {
        if (start <= end) {
    ...
    public static Path m۱۰۴۲۸b(String pathData) {
        Path path = new Path();
        Cb[] nodes = m۱۰۴۲۶a(pathData);
        if (nodes == null) {
            return null;
        }
        try {
            Cb.m۱۰۴۳۴a(nodes, path);
            return path;
    ...
    /* renamed from: a  reason: contains not printable characters */
    public static Cb[] m۱۰۴۲۶a(String pathData) {
        if (pathData == null) {
            return null;
        }
        int start = 0;
        ...
        while (end < pathData.length()) {
            int end2 = m۱۰۴۲۱a(pathData, end);
            String s = pathData.substring(start, end2).trim();
            if (s.length() > 0) {
                m۱۰۴۲۳a((ArrayList<Cb>) list, s.charAt(0), m۱۰۴۳۰c(s));
            }
            start = end2;
            end = end2 + 1;
        }
        if (end - start == 1 && start < pathData.length()) {
            m۱۰۴۲۳a((ArrayList<Cb>) list, pathData.charAt(start), new float[0]);
        }
        return (Cb[]) list.toArray(new Cb[list.size()]);
    }

    /* renamed from: a  reason: contains not printable characters */
    public static Cb[] m۱۰۴۲۷a(Cb[] source) {
        if (source == null) {
            return null;
        }
        Cb[] copy = new Cb[source.length];
        for (int i = 0; i < source.length; i++) {
            copy[i] = new Cb(source[i]);
        }
        return copy;
    }

    /* renamed from: a  reason: contains not printable characters */
    public static boolean m۱۰۴۲۴a(Cb[] nodesFrom, Cb[] nodesTo) {
    ...
    /* renamed from: b  reason: contains not printable characters */
    public static void m۱۰۴۲۹b(Cb[] target, Cb[] source) {
        for (int i = 0; i < source.length; i++) {
    ...
    /* renamed from: a  reason: contains not printable characters */
    private static int m۱۰۴۲۱a(String s, int end) {
        while (end < s.length()) {
            char c = s.charAt(end);
    ...
    /* renamed from: a  reason: contains not printable characters */
    private static void m۱۰۴۲۳a(ArrayList<Cb> arrayList, char cmd, float[] val) {
        arrayList.add(new Cb(cmd, val));
    }

    /* access modifiers changed from: private */
    /* renamed from: a.b.g.a.b$a  reason: invalid class name */
    ...
    private static float[] m۱۰۴۳۰c(String s) {
        ...
        try {
            ...
            while (startPosition < totalLength) {
                m۱۰۴۲۲a(s, startPosition, result);
            ...
            return m۱۰۴۲۵a(results, 0, count);
    ...
    private static void m۱۰۴۲۲a(java.lang.String r7, int r8, p۰۰۰a.p۰۰۵b.p۰۲۳g.p۰۲۴a.Cb.Ca r9) {
        /*
            r0 = r8
            r1 = 0
            r2 = 0
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p۰۰۰a.p۰۰۵b.p۰۲۳g.p۰۲۴a.Cb.m۱۰۴۲۲a(java.lang.String, int, a.b.g.a.b$a):void");
    }

    /* renamed from: a.b.g.a.b$b  reason: invalid class name */
    public static class Cb {
        ...
        Cb(Cb n) {
            ...
            float[] fArr = n.f۸۶۴۸b;
            this.f۸۶۴۸b = Cb.m۱۰۴۲۵a(fArr, 0, fArr.length);
        }

        /* renamed from: a  reason: contains not printable characters */
        public static void m۱۰۴۳۴a(Cb[] node, Path path) {
            float[] current = new float[6];
            char previousCommand = 'm';
            for (int i = 0; i < node.length; i++) {
                m۱۰۴۳۳a(path, current, previousCommand, node[i].f۸۶۴۷a, node[i].f۸۶۴۸b);
                previousCommand = node[i].f۸۶۴۷a;
            }
        }

        /* renamed from: a  reason: contains not printable characters */
        public void m۱۰۴۳۵a(Cb nodeFrom, Cb nodeTo, float fraction) {
            int i = 0;
            while (true) {
        ...
        /* renamed from: a  reason: contains not printable characters */
        private static void m۱۰۴۳۳a(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            int incr;
            int k;
            ...
            while (k2 < val.length) {
                if (cmd == 'A') {
                    k = k2;
                    m۱۰۴۳۲a(path, currentX2, currentY2, val[k + 5], val[k + 6], val[k + 0], val[k + 1], val[k + 2], val[k + 3] != 0.0f, val[k + 4] != 0.0f);
                    currentX2 = val[k + 5];
                    currentY2 = val[k + 6];
                    ...
                    k = k2;
                    m۱۰۴۳۲a(path, currentX2, currentY2, val[k2 + 5] + currentX2, val[k2 + 6] + currentY2, val[k2 + 0], val[k2 + 1], val[k2 + 2], val[k2 + 3] != 0.0f, val[k2 + 4] != 0.0f);
                    currentX2 += val[k + 5];
                    currentY2 += val[k + 6];
                    ctrlPointX2 = currentX2;
                    ctrlPointY2 = currentY2;
        ...
        /* renamed from: a  reason: contains not printable characters */
        private static void m۱۰۴۳۲a(Path p, float x0, float y0, float x1, float y1, float a, float b, float theta, boolean isMoreThanHalf, boolean isPositiveArc) {
            double cy;
            double cx;
            ...
            if (disc < 0.0d) {
                ...
                m۱۰۴۳۲a(p, x0, y0, x1, y1, a * adjust, b * adjust, theta, isMoreThanHalf, isPositiveArc);
                return;
            }
            ...
            Double.isNaN(d17);
            double cy2 = d17 * cy;
            m۱۰۴۳۱a(p, (cx2 * cosTheta) - (cy2 * sinTheta), (cx2 * sinTheta) + (cy2 * cosTheta), (double) a, (double) b, (double) x0, (double) y0, thetaD, eta0, sweep);
        }
        ...
        /* renamed from: a  reason: contains not printable characters */
        private static void m۱۰۴۳۱a(Path p, double cx, double cy, double a, double b, double e1x, double e1y, double theta, double start, double sweep) {
            double d = a;
