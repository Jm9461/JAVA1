...
import com.lawyer_smartCalendar.a.c0;
...
public class p extends f implements View.OnClickListener {
    ...
    public void a(View view, Bundle savedInstanceState) {
        ...
        this.a0 = (FloatingActionButton) view.findViewById(R.id.actionButton_add_honorarium);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.actionButton_add_honorarium) {
            Intent frm_add_note = new Intent(d(), AddPaymentActivity.class);
    ...
    public void d0() {
        i db = new i(d());
        db.n();
        List<Payment> paymentList = db.k();
        db.close();
        this.b0.setAdapter(new c0(d(), this, paymentList));
