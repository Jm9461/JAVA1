...
class Ch extends AbstractCg {
    ...
    public Ch(float[] color, float fromX, float toX, float fromY, float toY, byte direction, Random random) {
        ...
        this.f۱۲۶۶۸i = toY;
        this.f۱۲۶۶۴e = random;
        this.f۱۲۶۷۰k = direction != 0 ? 3.1415927f : 0.0f;
        m۱۳۹۱۵f();
        m۱۳۹۱۴e();
    }

    /* renamed from: e, reason: contains not printable characters */
    private void m۱۳۹۱۴e() {
        ...
        int i2 = indices.length;
        ByteBuffer indicesByteBuffer = ByteBuffer.allocateDirect(i2 * 2);
    ...
    /* renamed from: f, reason: contains not printable characters */
    private void m۱۳۹۱۵f() {
        int size = 45 * 3;
        this.f۱۲۶۶۹j = new float[size];
        this.f۱۲۶۶۹j[0] = Cl.m۱۳۹۴۰b(0.0f, this.f۱۲۶۶۵f, this.f۱۲۶۶۶g);
        this.f۱۲۶۶۹j[1] = Cl.m۱۳۹۴۰b(-1.0f, this.f۱۲۶۶۷h, this.f۱۲۶۶۸i);
        this.f۱۲۶۶۹j[3] = Cl.m۱۳۹۴۰b(-1.0f, this.f۱۲۶۶۵f, this.f۱۲۶۶۶g);
        this.f۱۲۶۶۹j[4] = Cl.m۱۳۹۴۰b(-1.0f, this.f۱۲۶۶۷h, this.f۱۲۶۶۸i);
        float[] fArr = this.f۱۲۶۶۹j;
        fArr[6] = fArr[3];
        fArr[7] = Cl.m۱۳۹۴۰b(0.0f, this.f۱۲۶۶۷h, this.f۱۲۶۶۸i);
        float[] fArr2 = this.f۱۲۶۶۹j;
        fArr2[fArr2.length - 6] = Cl.m۱۳۹۴۰b(1.0f, this.f۱۲۶۶۵f, this.f۱۲۶۶۶g);
    ...
    public void m۱۳۹۱۷b(float dAngle) {
        ...
        if (this.f۱۲۶۷۱l == 0.0f) {
            float f2 = this.f۱۲۶۷۲m;
            if (f2 > 0.0f) {
                this.f۱۲۶۷۱l = Cl.m۱۳۹۴۱c(0.0f, f2, 0.35f);
            }
        }
        float val = ((float) Math.sin(angle)) * this.f۱۲۶۷۱l;
        if ((this.f۱۲۶۷۳n > 0.0f && val <= 0.0f) || (this.f۱۲۶۷۳n < 0.0f && val >= 0.0f)) {
            this.f۱۲۶۷۱l = Cl.m۱۳۹۴۱c(this.f۱۲۶۷۱l, this.f۱۲۶۷۲m, 0.35f);
            this.f۱۲۶۷۴o = this.f۱۲۶۶۴e.nextFloat() * 0.3f * (this.f۱۲۶۶۴e.nextBoolean() ? 1 : -1);
        }
        this.f۱۲۶۷۳n = val;
        int i = 0;
        float posX = Cl.m۱۳۹۴۰b(this.f۱۲۶۷۴o, this.f۱۲۶۶۵f, this.f۱۲۶۶۶g);
        float posY = Cl.m۱۳۹۴۰b(val, this.f۱۲۶۶۷h, this.f۱۲۶۶۸i);
        float time = 0.0f;
        while (time < 1.0d - (0.025d / 2.0d)) {
            float[] fArr = this.f۱۲۶۶۹j;
            int i2 = f۱۲۶۶۱p;
            fArr[(i * 3) + 1 + i2] = angle;
            this.f۱۲۶۶۲c.put((i * 3) + i2, Cl.m۱۳۹۳۴a(time, fArr[6], posX, fArr[fArr.length - 6]));
            FloatBuffer floatBuffer = this.f۱۲۶۶۲c;
            int i3 = (i * 3) + 1 + f۱۲۶۶۱p;
            float[] fArr2 = this.f۱۲۶۶۹j;
            floatBuffer.put(i3, Cl.m۱۳۹۳۴a(time, fArr2[7], posY, fArr2[fArr2.length - 5]));
            i++;
            double d2 = time;
            Double.isNaN(d2);
    ...
    /* renamed from: d, reason: contains not printable characters */
    public boolean m۱۳۹۱۹d() {
        return Math.abs(this.f۱۲۶۷۳n) < 0.001f;
    }

    /* renamed from: a, reason: contains not printable characters */
    public void m۱۳۹۱۶a(float coefficient) {
