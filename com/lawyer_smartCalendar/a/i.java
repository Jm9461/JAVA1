...
public class i extends RecyclerView.g<a> {
    ...
    private Context f۲۹۸۴c;

    /* renamed from: d  reason: collision with root package name */
    private List<com.lawyer_smartCalendar.d.i> f۲۹۸۵d;

    /* renamed from: e  reason: collision with root package name */
    private f f۲۹۸۶e = new f(this.f۲۹۸۴c);

    /* renamed from: f  reason: collision with root package name */
    private Calendar f۲۹۸۷f = Calendar.getInstance();

    /* renamed from: g  reason: collision with root package name */
    private com.lawyer_smartCalendar.c.i f۲۹۸۸g;
    ...
    public class a extends RecyclerView.d0 {
        ...
        public a(View convertView) {
            ...
            convertView.setOnClickListener(new View$OnClickListenerC۰۰۸۴a(i.this));
        }

        /* renamed from: com.lawyer_smartCalendar.a.i$a$a  reason: collision with other inner class name */
        class View$OnClickListenerC۰۰۸۴a implements View.OnClickListener {
            View$OnClickListenerC۰۰۸۴a(i iVar) {
            }

            public void onClick(View view) {
                Intent frmSchedule = new Intent(i.this.f۲۹۸۴c, ScheduleDetailActivity.class);
                frmSchedule.putExtra("id", ((com.lawyer_smartCalendar.d.i) i.this.f۲۹۸۵d.get(a.this.f())).e() + "");
                i.this.f۲۹۸۸g.b(frmSchedule);
            }
        }
    }

    public i(Context Activity, com.lawyer_smartCalendar.c.i fragmentTab1, List<com.lawyer_smartCalendar.d.i> list) {
        a(true);
        this.f۲۹۸۴c = Activity;
        this.f۲۹۸۵d = list;
        this.f۲۹۸۸g = fragmentTab1;
    }
    ...
    public void b(com.lawyer_smartCalendar.a.i.a r9, int r10) {
        /*
        // Method dump skipped, instructions count: 299
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lawyer_smartCalendar.a.i.b(com.lawyer_smartCalendar.a.i$a, int):void");
    }

    @Override // android.support.v7.widget.RecyclerView.g
    public int a() {
        return this.f۲۹۸۵d.size();
    }
