...
public class Ci {
    ...
    public static File m۱۰۴۸۵a(Context context) {
    ...
    private static java.nio.ByteBuffer m۱۰۴۸۸a(java.io.File r7) {
        /*
        ...
        L_0x0025:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p۰۰۰a.p۰۰۵b.p۰۲۳g.p۰۲۴a.Ci.m۱۰۴۸۸a(java.io.File):java.nio.ByteBuffer");
    }
    ...
    /* renamed from: a  reason: contains not printable characters */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.nio.ByteBuffer m۱۰۴۸۷a(android.content.Context r10, android.os.CancellationSignal r11, android.net.Uri r12) {
        /*
        ...
        L_0x0050:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p۰۰۰a.p۰۰۵b.p۰۲۳g.p۰۲۴a.Ci.m۱۰۴۸۷a(android.content.Context, android.os.CancellationSignal, android.net.Uri):java.nio.ByteBuffer");
    }

    /* renamed from: a  reason: contains not printable characters */
    public static ByteBuffer m۱۰۴۸۶a(Context context, Resources res, int id) {
        File tmpFile = m۱۰۴۸۵a(context);
        ByteBuffer byteBuffer = null;
        if (tmpFile == null) {
            return null;
        }
        try {
            if (m۱۰۴۹۰a(tmpFile, res, id)) {
                byteBuffer = m۱۰۴۸۸a(tmpFile);
            }
            return byteBuffer;
        } finally {
            tmpFile.delete();
    ...
    /* renamed from: a  reason: contains not printable characters */
    public static boolean m۱۰۴۹۱a(File file, InputStream is) {
    ...
    /* renamed from: a  reason: contains not printable characters */
    public static boolean m۱۰۴۹۰a(File file, Resources res, int id) {
        InputStream is = null;
        try {
            is = res.openRawResource(id);
            return m۱۰۴۹۱a(file, is);
        } finally {
            m۱۰۴۸۹a(is);
        }
    }
    ...
    /* renamed from: a  reason: contains not printable characters */
    public static void m۱۰۴۸۹a(Closeable c) {
        if (c != null) {
            try {
                c.close();
            } catch (IOException e) {
