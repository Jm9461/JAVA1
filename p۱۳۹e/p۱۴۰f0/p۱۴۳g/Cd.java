...
public final class Cd {
    ...
    private static final ThreadLocal<DateFormat> f۱۵۸۲۲a = new Ca();
    ...
    /* renamed from: e.f0.g.d$a  reason: invalid class name */
    class Ca extends ThreadLocal<DateFormat> {
        Ca() {
        }
    ...
    /* renamed from: a  reason: contains not printable characters */
    public static Date m۱۸۷۶۲a(String value) {
        if (value.length() == 0) {
            return null;
        }
    ...
    /* renamed from: a  reason: contains not printable characters */
    public static String m۱۸۷۶۱a(Date value) {
