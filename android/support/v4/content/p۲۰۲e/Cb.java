...
public final class Cb {
    ...
    /* renamed from: a, reason: contains not printable characters */
    static Cb m۱۰۵۷۶a(Shader shader) {
        return new Cb(shader, null, 0);
    }

    /* renamed from: a, reason: contains not printable characters */
    static Cb m۱۰۵۷۴a(ColorStateList colorStateList) {
        return new Cb(null, colorStateList, colorStateList.getDefaultColor());
    }

    /* renamed from: b, reason: contains not printable characters */
    static Cb m۱۰۵۷۷b(int color) {
        return new Cb(null, null, color);
    }

    /* renamed from: b, reason: contains not printable characters */
    public Shader m۱۰۵۸۲b() {
        return this.f۱۰۴۶۲a;
    }
    ...
    public boolean m۱۰۵۸۵e() {
        return m۱۰۵۸۳c() || this.f۱۰۴۶۴c != 0;
    }

    /* renamed from: b, reason: contains not printable characters */
    public static Cb m۱۰۵۷۸b(Resources resources, int resId, Resources.Theme theme) {
        try {
            return m۱۰۵۷۵a(resources, resId, theme);
        } catch (Exception e2) {
    ...
    /* renamed from: a, reason: contains not printable characters */
    private static Cb m۱۰۵۷۵a(Resources resources, int resId, Resources.Theme theme) {
        int type;
        ...
        if (c2 == 0) {
            return m۱۰۵۷۴a(Ca.m۱۰۵۷۱a(resources, parser, attrs, theme));
        }
        if (c2 == 1) {
            return m۱۰۵۷۶a(Cd.m۱۰۶۰۵a(resources, parser, attrs, theme));
        }
