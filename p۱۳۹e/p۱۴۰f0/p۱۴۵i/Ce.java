...
public final class Ce {
    ...
    static final Cf f۱۵۹۱۰a = Cf.m۱۹۴۳۸d("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");
    ...
    static {
        ...
        while (true) {
            ...
            strArr[i] = Cc.m۱۸۶۱۴a("%8s", Integer.toBinaryString(i)).replace(' ', '0');
            i++;
        }
    ...
    /* renamed from: a  reason: contains not printable characters */
    static IllegalArgumentException m۱۸۸۶۳a(String message, Object... args) {
        throw new IllegalArgumentException(Cc.m۱۸۶۱۴a(message, args));
    }

    /* renamed from: b  reason: contains not printable characters */
    static IOException m۱۸۸۶۶b(String message, Object... args) {
        throw new IOException(Cc.m۱۸۶۱۴a(message, args));
    }

    /* renamed from: a  reason: contains not printable characters */
    static String m۱۸۸۶۵a(boolean inbound, int streamId, int length, byte type, byte flags) {
        String[] strArr = f۱۵۹۱۱b;
        String formattedType = type < strArr.length ? strArr[type] : Cc.m۱۸۶۱۴a("0x%02x", Byte.valueOf(type));
        String formattedFlags = m۱۸۸۶۴a(type, flags);
        ...
        return Cc.m۱۸۶۱۴a("%s 0x%08x %5d %-13s %s", objArr);
    }

    /* renamed from: a  reason: contains not printable characters */
    static String m۱۸۸۶۴a(byte type, byte flags) {
        if (flags == 0) {
            return "";
        }
        if (!(type == 2 || type == 3)) {
