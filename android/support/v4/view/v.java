...
public final class v {
    ...
    private static Method f۱۳۸۲a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f۱۳۸۲a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
            } catch (Exception e2) {
    ...
    public static float c(ViewConfiguration config, Context context) {
        if (Build.VERSION.SDK_INT >= 26) {
    ...
    private static float a(ViewConfiguration config, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f۱۳۸۲a) != null) {
            try {
    ...
    public static boolean d(ViewConfiguration config, Context context) {
        if (Build.VERSION.SDK_INT >= 28) {
