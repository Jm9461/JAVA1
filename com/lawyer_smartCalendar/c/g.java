...
public class g extends f implements View.OnClickListener {
    ...
    public void a(View view, Bundle savedInstanceState) {
        ...
        this.a0 = (RecyclerView) view.findViewById(R.id.recyclerView_view);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.actionButton_add_document) {
            Intent frm_note = new Intent(d(), AddClientDocumentsActivity.class);
    ...
    public void d0() {
        i db = new i(d());
        db.n();
        List<ClientDocument> clientDocuments = db.m(((CaseDetailActivity) d()).r);
        db.close();
        this.a0.setAdapter(new com.lawyer_smartCalendar.a.g(d(), this, clientDocuments));
