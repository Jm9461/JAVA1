...
public class h extends RecyclerView.g<a> {
    ...
    private Context f۲۹۷۸c;

    /* renamed from: d  reason: collision with root package name */
    private List<f> f۲۹۷۹d;

    /* renamed from: e  reason: collision with root package name */
    private com.lawyer_smartCalendar.utils.f f۲۹۸۰e = new com.lawyer_smartCalendar.utils.f(this.f۲۹۷۸c);

    /* renamed from: f  reason: collision with root package name */
    private Calendar f۲۹۸۱f = Calendar.getInstance();

    /* renamed from: g  reason: collision with root package name */
    private com.lawyer_smartCalendar.c.h f۲۹۸۲g;
    ...
    public class a extends RecyclerView.d0 {
        ...
        public a(View convertView) {
            ...
            convertView.setOnClickListener(new View$OnClickListenerC۰۰۸۳a(h.this));
        }

        /* renamed from: com.lawyer_smartCalendar.a.h$a$a  reason: collision with other inner class name */
        class View$OnClickListenerC۰۰۸۳a implements View.OnClickListener {
            View$OnClickListenerC۰۰۸۳a(h hVar) {
            }

            public void onClick(View view) {
                Intent frmNote = new Intent(h.this.f۲۹۷۸c, NoteDetailActivity.class);
                frmNote.putExtra("id", ((f) h.this.f۲۹۷۹d.get(a.this.f())).e() + "");
                h.this.f۲۹۸۲g.b(frmNote);
            }
        }
    }

    public h(Context Activity, com.lawyer_smartCalendar.c.h fragmentTab1, List<f> list) {
        a(true);
        this.f۲۹۷۸c = Activity;
        this.f۲۹۷۹d = list;
        this.f۲۹۸۲g = fragmentTab1;
    }
    ...
    public void b(com.lawyer_smartCalendar.a.h.a r9, int r10) {
        /*
        // Method dump skipped, instructions count: 299
        */
        throw new UnsupportedOperationException("Method not decompiled: com.lawyer_smartCalendar.a.h.b(com.lawyer_smartCalendar.a.h$a, int):void");
    }

    @Override // android.support.v7.widget.RecyclerView.g
    public int a() {
        return this.f۲۹۷۹d.size();
    }
