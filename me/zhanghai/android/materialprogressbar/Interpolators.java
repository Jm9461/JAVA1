...
import android.support.v4.view.e0.f;
...
class Interpolators {
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X {
        public static final Interpolator INSTANCE = f.a(PATH_INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X);
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT1_SCALE_X {
        public static final Interpolator INSTANCE = f.a(PATH_INDETERMINATE_HORIZONTAL_RECT1_SCALE_X);
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X {
        public static final Interpolator INSTANCE = f.a(PATH_INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X);
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT2_SCALE_X {
        public static final Interpolator INSTANCE = f.a(PATH_INDETERMINATE_HORIZONTAL_RECT2_SCALE_X);
    ...
    public static class TRIM_PATH_START {
        public static final Interpolator INSTANCE = f.a(PATH_TRIM_PATH_START);
    ...
    public static class TRIM_PATH_END {
        public static final Interpolator INSTANCE = f.a(PATH_TRIM_PATH_END);
